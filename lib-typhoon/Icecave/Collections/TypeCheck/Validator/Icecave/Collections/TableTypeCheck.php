...
class TableTypeCheck extends \Icecave\Collections\TypeCheck\AbstractValidator
{
    public function fromCollection(array $arguments)
    {
    ...
    public function validateConstruct(array $arguments)
    {
        $argumentCount = \count($arguments);
        if ($argumentCount < 1) {
            throw new \Icecave\Collections\TypeCheck\Exception\MissingArgumentException('columnNames', 0, 'mixed<mixed>|Icecave\\Collections\\IterableInterface');
        ...
        $check = function ($value) {
            ...
            return $value instanceof \Icecave\Collections\IterableInterface;
        };
        if (!$check($arguments[0])) {
            throw new \Icecave\Collections\TypeCheck\Exception\UnexpectedArgumentValueException(
                'columnNames',
                0,
                $arguments[0],
                'mixed<mixed>|Icecave\\Collections\\IterableInterface'
            );
        }
        if ($argumentCount > 1) {
            $value = $arguments[1];
    ...
    public function set(array $arguments)
    {
        ...
        if ($argumentCount < 2) {
            ...
            throw new \Icecave\Collections\TypeCheck\Exception\MissingArgumentException('element', 1, 'Icecave\\Collections\\AssociativeInterface|mixed<mixed>');
        } elseif ($argumentCount > 2) {
            throw new \Icecave\Collections\TypeCheck\Exception\UnexpectedArgumentException(2, $arguments[2]);
        }
        $value = $arguments[0];
        ...
        if (!$check($arguments[1])) {
            throw new \Icecave\Collections\TypeCheck\Exception\UnexpectedArgumentValueException(
                ...
                1,
                $arguments[1],
                'Icecave\\Collections\\AssociativeInterface|mixed<mixed>'
            );
        }
    }
    ...
    public function columnNames(array $arguments)
    {
        if (\count($arguments) > 0) {
            throw new \Icecave\Collections\TypeCheck\Exception\UnexpectedArgumentException(0, $arguments[0]);
        }
    ...
    public function elementSize(array $arguments)
    {
        if (\count($arguments) > 0) {
            throw new \Icecave\Collections\TypeCheck\Exception\UnexpectedArgumentException(0, $arguments[0]);
        }
    ...
    public function indexOfColumn(array $arguments)
    {
        $argumentCount = \count($arguments);
        if ($argumentCount < 1) {
            throw new \Icecave\Collections\TypeCheck\Exception\MissingArgumentException('columnName', 0, 'string');
        } elseif ($argumentCount > 1) {
            throw new \Icecave\Collections\TypeCheck\Exception\UnexpectedArgumentException(1, $arguments[1]);
        }
        $value = $arguments[0];
    ...
    public function predicateByElement(array $arguments)
    {
        $argumentCount = \count($arguments);
        if ($argumentCount < 1) {
            throw new \Icecave\Collections\TypeCheck\Exception\MissingArgumentException('element', 0, 'mixed');
